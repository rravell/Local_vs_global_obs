...
def operator_list(N, operator, func): #QUTIP
    Ens_Op_list=[]
    I=qt.qeye(2)
...
def operator_list_g_full(N): #QUTIP
    Ens_Op_list=[]
    I=qt.qeye(2)
...
def operator_list_g2_full(N): #QUTIP
    Ens_Op_list=[]
    I=qt.qeye(2)
...
def operator_list_swap(N):  # QUTIP
    Ens_Op_list = []
...
def operator_list_same(N):  # QUTIP
    Ens_Op_list = []
...
def Bx_dyn(seed,hs,dt,gamma,N):
    ...
    Observables = operator_list_swap(N)
    Observables+= operator_list_same(N)
    ...
    filename2 = "perfL_global/seed_" + str(float(seed)) + "_dT" + str(float(dt)) + "_hs" + str(float(hs))+ "_gamma" + str(float(gamma))+ "_N"+str(float(N)) +".npy"
    filename3 = "perfN_global/seed_" + str(float(seed)) + "_dT" + str(float(dt)) + "_hs" + str(float(hs))+ "_gamma" + str(float(gamma))+ "_N"+str(float(N)) +".npy"
